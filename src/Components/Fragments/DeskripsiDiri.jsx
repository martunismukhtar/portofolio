const DeskripsiDiri=()=>{
    // const 
    return (
        <div id="deskripsi" className="flex flex-col items-center justify-center py-[4%] px-[2%] sm:px-[15%]">
...
reliability. Adept at collaborating with stakeholders and committed to continuous learning and
innovation.
            </p>
        </div>
    )
